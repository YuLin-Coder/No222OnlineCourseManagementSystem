					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>资讯管理</span></li>
								<li class="breadcrumb-item active"><span>资讯列表</span></li>
							</ol>
						</div>
					</div>
				</div>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th>图片</th>
											<th onclick="sort('gonggaoneirong')">资讯内容<i id="gonggaoneirongIcon" class="fa fa-sort"></i></th>
