      ...
      <div class="form-inner">
          ...
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="xuehao" name="xuehao" placeholder="请输入学号" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="xueyuan" name="xueyuan" placeholder="请输入学院" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
