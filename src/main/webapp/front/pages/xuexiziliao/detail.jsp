				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div v-if="detail.alllimittimes" class="detail-item">
							...
							<span>课程文件：</span>
							<span class="desc">
								<a download="kechengwenjian" :href="detail.kechengwenjian">点击下载</a>
							</span>
						</div>
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('xuexiziliao','做笔记')" @click="onAcrossTap('xuexibiji')" type="button" class="layui-btn">
								做笔记
							</button>
